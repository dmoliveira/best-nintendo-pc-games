...
const catalogSitemapLocation = `<loc>${expectedSiteUrl.replace(/\/$/, "")}/catalog/</loc>`;
const catalogSitemapLocationCount = sitemap.split(catalogSitemapLocation).length - 1;
if (catalogSitemapLocationCount !== 1) fail(`sitemap must include exactly one canonical catalog index location, found ${catalogSitemapLocationCount}`);
