...
test("catalog cards expose one game route and describe compact metadata and external destinations", () => {
  ...
  const markup = renderToStaticMarkup(createElement(CatalogCards, { records: [record], basePath: "/best-nintendo-pc-games" }));
  ...
  assert.match(markup, /class="game-card-filter-link" data-catalog-filter="platform" aria-label="Show games for Nintendo Switch" href="\/best-nintendo-pc-games\/\?platform=nintendo-switch#games"/);
  ...
  assert.match(markup, /class="game-card-year game-card-filter-link" data-catalog-filter="year" aria-label="Show games first released in 2020" href="\/best-nintendo-pc-games\/\?year=2020#games"/);
  ...
  const compactMarkup = renderToStaticMarkup(createElement(CatalogCards, { records: [record], basePath: "/best-nintendo-pc-games", showImages: false }));
