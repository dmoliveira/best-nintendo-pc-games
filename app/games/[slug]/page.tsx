...
import { getCatalogGame, getCatalogGames, getEditorialSignals, getGameBoxFront, getGameEditorialArt, getGenreHub, getPlatformHub, getPublicGameSignals } from "@/lib/catalog/site-data";
...
export default async function GamePage({ params }: GamePageProps) {
  ...
  const isFrozenCatalogEntry = game.sources.includes("wikidata-fact-reference");
